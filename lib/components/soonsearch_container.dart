...
class SoonSearchContainer extends StatelessWidget {
  final SearchItem2 search;
  final SoonExpiredModel? product;

  const SoonSearchContainer({Key? key, required this.search,  this.product}) : super(key: key);
