...
class ExSearchContainer extends StatelessWidget {
  final SearchItem1 search;
  final ExpiredModel? product;

  const ExSearchContainer({Key? key, required this.search,  this.product}) : super(key: key);
